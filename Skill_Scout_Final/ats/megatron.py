...
def search_applicants(skills_needed, threshold):
    ...
    for filename in os.listdir('D:/New folder/Skill_Scout_Final/ats/resumes'):
        ...
        if len(skills_matched) / len(skills_needed) *100 >= threshold:
...
image = Image.open("D:/New folder/Skill_Scout_Final/ats/templates/bg1.jpg")
...
threshold_label = tk.Label(root, text="Threshold (in %):")
